defmodule Pdf.TableTest do
  ...
  setup do
    ...
    # Use the preloaded fonts/objects but reset the stream
    page = %{page | fonts: preloaded.fonts, objects: preloaded.objects}
  ...
  test "row exceeds available space" do
    ...
    page = Page.new(size: [100, 100], fonts: fonts, objects: objects, compress: false)
