defmodule Pdf.DevServer do
  ...
  alias Pdf.DevServer.{PageController, PdfController, ApiController, ReceiptController}
  ...
  # Booking receipt — remote data via ReceiptController
  get "/receipt/:order_id", do: ReceiptController.show(conn, order_id)
